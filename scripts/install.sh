...
print_next_steps() {
    ...
    printf "    nvh workstation                         ${DIM}# desktop icon + student GPU lab checklist${RESET}\n"
    printf "    nvh workstation --all -y                ${DIM}# local AI + ComfyUI + WebUI${RESET}\n"
    printf "    nvh studio --install starter -y         ${DIM}# rootless LLMs + agents + games${RESET}\n"
