  ...
  return (
    <div>
      ...
      <SectionCard title="Advanced Defaults">
        <div>
          <label className="block text-[10px] font-mono text-[#737373] mb-1.5 uppercase tracking-wider dark:text-[#a3a3a3]">API Server URL</label>
          <input
            type="text"
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block text-[10px] font-mono text-[#737373] mb-1.5 uppercase tracking-wider dark:text-[#a3a3a3]">Default AI Source</label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-[10px] font-mono text-[#737373] mb-1.5 uppercase tracking-wider dark:text-[#a3a3a3]">Default Model</label>
            <input
              type="text"
        ...
        <div>
          <div className="flex items-center justify-between mb-1.5">
            <label className="text-[10px] font-mono text-[#737373] uppercase tracking-wider dark:text-[#a3a3a3]">Default Temperature</label>
        ...
        <div>
          <label className="block text-[10px] font-mono text-[#737373] mb-1.5 uppercase tracking-wider dark:text-[#a3a3a3]">Answer Length Limit</label>
          <input
        ...
        <div>
          <label className="block text-[10px] font-mono text-[#737373] mb-1.5 uppercase tracking-wider dark:text-[#a3a3a3]">Output Format</label>
          <div className="flex gap-0 border border-[#d4d4d4] dark:border-[#404040]">
      ...
      <SectionCard title="NVIDIA Local AI">
        <div className="bg-[#76B900]/5 border border-[#76B900]/20 p-3">
          ...
          <div className="text-[10px] font-mono text-[#737373] space-y-1 dark:text-[#a3a3a3]">
            <div>Default Provider: <span className="text-[#0a0a0a] dark:text-[#fafafa]">ollama</span></div>
            <div>Default Model: <span className="text-[#76B900]">ollama/nemotron-mini</span></div>
            <div>Ollama URL: <span className="text-[#0a0a0a] dark:text-[#fafafa]">http://localhost:11434</span></div>
          </div>
          <button
            type="button"
            onClick={() => {
      ...
      <SectionCard title="Budget Limits">
        {budgetStatus && (
          <div className="bg-[#ffffff] border border-[#e5e5e5] p-3 mb-2 dark:bg-[#0a0a0a] dark:border-[#262626]">
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                ...
                <div key={label}>
                  <div className="text-[10px] font-mono text-[#a3a3a3] uppercase dark:text-[#737373]">{label}</div>
                  <div className="text-sm font-mono text-[#0a0a0a] dark:text-[#fafafa]">{value}</div>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block text-[10px] font-mono text-[#737373] mb-1.5 uppercase tracking-wider dark:text-[#a3a3a3]">Daily Limit (USD)</label>
            <div className="relative">
              <span className="absolute left-3 top-1/2 -translate-y-1/2 text-[#a3a3a3] text-sm font-mono dark:text-[#737373]">$</span>
              <input
          ...
          <div>
            <label className="block text-[10px] font-mono text-[#737373] mb-1.5 uppercase tracking-wider dark:text-[#a3a3a3]">Monthly Limit (USD)</label>
            <div className="relative">
              <span className="absolute left-3 top-1/2 -translate-y-1/2 text-[#a3a3a3] text-sm font-mono dark:text-[#737373]">$</span>
              <input
                type="number" min="0" step="0.01"
      ...
      <SectionCard title="Hive Settings">
        <div>
          <label className="block text-[10px] font-mono text-[#737373] mb-1.5 uppercase tracking-wider dark:text-[#a3a3a3]">Default Strategy</label>
          <select
        ...
        <div>
          <div className="flex items-center justify-between mb-1.5">
            <label className="text-[10px] font-mono text-[#737373] uppercase tracking-wider dark:text-[#a3a3a3]">Default Num Agents</label>
          ...
          <div className="flex justify-between mt-1">
            <span className="text-[10px] font-mono text-[#a3a3a3] dark:text-[#737373]">2</span>
            <span className="text-[10px] font-mono text-[#a3a3a3] dark:text-[#737373]">8</span>
          </div>
        </div>

        <div>
          <div className="flex items-center justify-between mb-1.5">
            <label className="text-[10px] font-mono text-[#737373] uppercase tracking-wider dark:text-[#a3a3a3]">Quorum Threshold</label>
      ...
      <SectionCard title="Data">
        <div>
          <div className="text-sm font-mono text-[#525252] mb-1 dark:text-[#a3a3a3]">Reset All Settings</div>
      ...
      <div className="text-center py-4 border-t border-[#e5e5e5] dark:border-[#262626]">
        ...
        <div className="text-[10px] font-mono text-[#a3a3a3] mt-1 dark:text-[#737373]">NVIDIA Nemotron - Next.js 14 - Tailwind CSS</div>
      </div>
      </div>
    </div>
  );
