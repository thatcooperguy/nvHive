...
| ~~Chat history sidebar (browse, resume, pin past conversations in the web UI)~~ **SHIPPED (chat-history polish, 0.41.0)** | Both — LibreChat and AnythingLLM have full conversation history UIs; it's table-stakes in every ChatGPT-class product | **shipped** | small |
