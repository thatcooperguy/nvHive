"""DeepSeek provider adapter via LiteLLM.

DeepSeek models are known for very low cost and strong reasoning ability.
They are accessed via https://api.deepseek.com using the ``deepseek/`` prefix.
"""
