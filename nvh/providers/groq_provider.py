"""Groq provider adapter via LiteLLM.

Groq is known for extremely low latency inference powered by their
custom Language Processing Units (LPUs).
"""
...
class GroqProvider:
    ...
    def estimate_tokens(self, text: str) -> int:
        # Groq serves open-source models; fall back to character heuristic
        return len(text) // 4
