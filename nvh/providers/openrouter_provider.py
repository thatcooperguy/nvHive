"""OpenRouter provider adapter via LiteLLM.

OpenRouter is a meta-aggregator that routes requests to the best available
provider for each model. Single API key, access to hundreds of models.
...
class OpenRouterProvider:
    """OpenRouter adapter using LiteLLM.

    OpenRouter is a meta-aggregator that routes to best-available providers.
    Supports hundreds of models from OpenAI, Anthropic, Meta, Google and more.
