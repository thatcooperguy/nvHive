"""SambaNova provider adapter via LiteLLM.

SambaNova offers high-performance AI inference on custom RDU hardware.
...
class SambaNovProvider:
    """SambaNova adapter using LiteLLM.

    SambaNova delivers fast inference on custom Reconfigurable Dataflow Unit (RDU)
    hardware with a free tier available. Set SAMBANOVA_API_KEY to authenticate.
    """
