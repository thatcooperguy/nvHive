"""Mistral provider adapter via LiteLLM.

Mistral AI models are accessed through the ``mistral/`` LiteLLM prefix
...
from nvh.providers.openai_provider import (
    _build_messages,
    _calc_cost,
    _map_error,
)
...
class MistralProvider:
    """Mistral AI adapter using LiteLLM.

    Models use the ``mistral/`` prefix (e.g. ``mistral/mistral-large-latest``).
    ...
    def __init__(
        self,
        api_key: str = "",
        default_model: str = "mistral/mistral-large-latest",
