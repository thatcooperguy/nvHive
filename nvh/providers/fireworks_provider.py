"""Fireworks AI provider adapter via LiteLLM.

Fireworks AI provides fast and cost-effective inference for open-source models.
...
class FireworksProvider:
    """Fireworks AI adapter using LiteLLM.

    Fireworks AI specializes in fast, cost-effective open-source model inference.
    Set FIREWORKS_API_KEY to authenticate.
    """
