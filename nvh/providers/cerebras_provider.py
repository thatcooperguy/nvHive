"""Cerebras provider adapter via LiteLLM.

Cerebras offers extremely fast inference using purpose-built Wafer-Scale Engine chips.
...
class CerebrasProvider:
    """Cerebras adapter using LiteLLM.

    Cerebras delivers extremely fast token generation (>1000 tokens/sec)
    using their Wafer-Scale Engine hardware. Ideal for latency-sensitive tasks.
    Set CEREBRAS_API_KEY to authenticate.
    """
