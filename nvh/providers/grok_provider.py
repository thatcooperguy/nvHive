"""Grok (xAI) provider adapter via LiteLLM.

Grok models are hosted by xAI and accessed via https://api.x.ai/v1.
LiteLLM uses the ``xai/`` model prefix.
"""
...
class GrokProvider:
    ...
    def __init__(
        ...
        # Always use the xAI base URL unless the caller explicitly overrides it
