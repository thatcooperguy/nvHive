"""Hugging Face Inference API provider adapter via LiteLLM.

Hugging Face hosts thousands of open-source models accessible via their Inference API.
...
class HuggingFaceProvider:
    """Hugging Face Inference API adapter using LiteLLM.

    Provides access to thousands of open-source models hosted on Hugging Face.
    Set HUGGINGFACE_API_KEY or HF_TOKEN to authenticate.
    A free inference tier is available with rate limits.
    """
