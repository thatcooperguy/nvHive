"""Together AI provider adapter via LiteLLM.

Together AI offers a large catalog of open-source models at competitive prices.
...
class TogetherProvider:
    """Together AI adapter using LiteLLM.

    Together AI hosts a wide range of open-source models.
    Set TOGETHER_API_KEY (or TOGETHERAI_API_KEY) to authenticate.
    """
